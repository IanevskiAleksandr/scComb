...
Dr_Info_FIMM = openxlsx::read.xlsx("/home/aianevsk/Desktop/projects/ScComb/ExampleDrugs.xlsx")

### GET COMPOUND IDs, no need to uncomment in case of demo data
###############################################################

# Dr_Info_FIMM <- data.frame(compounds_ = as.character(unique(Dr_Info_FIMM$compounds_)))
...
### GET TARGETS FROM DTC, no need to uncomment in case of demo data
###################################################################
...
# SCTransformed scRNA-seq data from SEURAT pipeline
